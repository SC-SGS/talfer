...
public:
	 ...
	 */
	inline void setTextureParameters(GLenum p_target = GL_TEXTURE_2D,
			GLint p_int_format = GL_RGBA, GLenum p_ext_format = GL_RGBA,
	 ...
	 * initialize texture
	 */
	inline CGlTexture(GLenum p_target = GL_TEXTURE_2D, GLint p_int_format =
			GL_RGBA, GLenum p_ext_format = GL_RGBA, GLenum p_ext_type =
			GL_UNSIGNED_BYTE) {
	...
	inline void setData(void *data) {
		...
		case GL_TEXTURE_3D:
			glTexImage3D(GL_TEXTURE_3D, 0, int_format, width, height, depth, 0,
					ext_format, ext_type, data);
			break;
